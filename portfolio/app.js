...
function renderHeroChart(data) {
  ...
  svg.innerHTML = `
    ...
    <rect x="32" y="22" width="156" height="30" rx="15" fill="#1d3028" stroke="#f2c66d" stroke-width="1"></rect>
    ...
    <rect x="206" y="22" width="122" height="30" rx="15" fill="#2a231f" stroke="#f08b70" stroke-width="1"></rect>
    <circle cx="224" cy="37" r="6" fill="#f08b70"></circle>
    <text x="238" y="42" fill="#f6f4ed" font-size="13" font-weight="800">violation</text>
